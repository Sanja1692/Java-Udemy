public class WholeNumbers {
    public static void main(String[] args) {
        ...
        long globalPopulation = 7000000000L;  // L has to be at end - reasure Java that we are using long number
        System.out.println("There are " + globalPopulation + " people on earth.");
        long dailyGoogleSearches = 5000000000L;  // L has to be at end - reasure Java that we are using long number
